  ...
  return (
    <main className="relative min-h-[100dvh] overflow-y-auto bg-background">
      ...
      <div className="relative z-10 mx-auto max-w-md px-7 pb-44">
        ...
        <Section title="What this is" emphasis="proposes">
          {
        ...
        <Section title="Where it's going" emphasis="yours">
          {
        ...
        <Section title="How it came to be" emphasis="listens">
...
function Glow({ children }: { children: React.ReactNode }) {
  return <span style={{ color: "#f5f5f5", textShadow: "0 0 10px rgba(255,255,255,0.45)" }}>{children}</span>
}
